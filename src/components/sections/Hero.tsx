...
const Hero = () => {
  ...
  />
          ...
          >
            ...
            <a href="/Habiba-Mohamed-CV.pdf" download>
             <Button size="lg" className="gap-2 glow-effect">
    <Download className="w-4 h-4" />
    Download CV
             </Button>
              </a>
              <a href="https://www.linkedin.com/in/habiba-mohamed-88901328a" target="_blank" rel="noreferrer">
           <Button size="lg" variant="outline" className="gap-2">
    <Linkedin className="w-4 h-4" />
    LinkedIn
           </Button>
            </a>
             <a href="https://github.com/Habiba-Mohamed5" target="_blank" rel="noreferrer">
