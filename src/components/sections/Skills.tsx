...

{
  ...
  skills: [
    ...
    { name: "Deep Learning (TensorFlow/PyTorch)", level: "Intermediate" },
    { name: "Computer Vision (OpenCV)", level: "Intermediate" },
    { name: "Generative AI & LLMs", level: "Learning" },
    { name: "Natural Language Processing (NLP)", level: "Learning" },
    { name: "Data Visualization (PowerBI/Tableau)", level: "Intermediate" },
    { name: "SQL for Data Science", level: "Advanced" },
  ],
},
  {
    id: "database",
